...
export const TOOLS = [
    ...
    {
        name: 'get_order_book',
        description: 'Fetch the current order book for a symbol. Use this to assess liquidity and estimate slippage before sizing an order.',
        input_schema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Fetch the most recent public trades for a symbol. Use this to read tape momentum — who is aggressive, buyer or seller.',
        input_schema: {
            type: 'object',
            properties: {
                symbol: { type: 'string', description: 'Trading pair symbol' },
    ...
    },
    {
        ...
        description: 'Fetch all currently open orders for a symbol (or all symbols if omitted). Use this to review existing positions before making new decisions.',
        input_schema: {
            type: 'object',
            properties: {
