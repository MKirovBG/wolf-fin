...
function classifyState(candle, prevCandle, currentAtr, emaValues, idx, slopeWindow) {
...
// ── Main export ───────────────────────────────────────────────────────────────
export function runMarkov(m1) {
    const states = ['TRENDING_UP', 'TRENDING_DOWN', 'RANGING', 'VOLATILE'];
...
//# sourceMappingURL=mc-markov.js.map