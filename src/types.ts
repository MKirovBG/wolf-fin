...
export interface IndicatorConfig {
  ...
  atrEnabled?: boolean           // Include ATR (default true — disable to remove ATR from snapshots/sizing)
  emaFastEnabled?: boolean       // Include fast EMA (default true)
  emaSlowEnabled?: boolean       // Include slow EMA (default true)
  bbEnabled?: boolean            // Include Bollinger Bands width (default true)
